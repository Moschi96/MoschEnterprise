...
from Data_handling.load_data import getdata_R32_PI5
...
R32_PI5_Df_raw = getdata_R32_PI5()
...
def clean_R410A_DF():
    ...
    R410A_Df['lambda'] = R410A_Df_raw['lambda']
    return R410A_Df
...
def clean_R32_DF():
    ...
    R32_Df['lambda'] = R32_Df_raw['lambda']
    return R32_Df
...
def clean_R290_DF():
    ...
    R290_Df['lambda'] = R290_Df_raw['lambda']
    return R290_Df
...
def clean_R454C_DF():
    ...
    R454C_Df['lambda'] = R454C_Df_raw['lambda']
    return R454C_Df
...
def clean_R32_PI25_DF():
    ...
    #R32_PI25_Df['lambda'] = R32_PI25_Df_raw['lambda']
...
def clean_R32_PI3_DF():
    ...
    #R32_PI3_Df['lambda'] = R32_PI3_Df_raw['lambda']
...
def clean_R32_PI35_DF():
    ...
    #R32_PI35_Df['lambda'] = R32_PI35_Df_raw['lambda']
    # R32_Df['T_Evaps'] = R32_Df_raw['T_Evaps']
    # R32_Df['T_Conds'] = R32_Df_raw['T_Conds']
...
def clean_R32_PI4_DF():
    ...
    #R32_PI4_Df['lambda'] = R32_PI4_Df_raw['lambda']
    # R32_Df['T_Evaps'] = R32_Df_raw['T_Evaps']
    # R32_Df['T_Conds'] = R32_Df_raw['T_Conds']
...
def clean_R32_PI45_DF():
    ...
    #R32_PI45_Df['lambda'] = R32_PI45_Df_raw['lambda']
...
def clean_R32_PI5_DF():
    R32_PI5_Df = pd.DataFrame()
    R32_PI5_Df['P1_Process'] =R32_PI5_Df_raw['P1_Process']
    R32_PI5_Df['P1_Process'] = R32_PI5_Df_raw['P1_Process']
    R32_PI5_Df['P1_Set'] = R32_PI5_Df_raw['P1_Set']
    R32_PI5_Df['P2_Set'] = R32_PI5_Df_raw['P2_Set']
    R32_PI5_Df['P2_Process'] = R32_PI5_Df_raw['P2_Process']
    R32_PI5_Df['T1_Process'] = R32_PI5_Df_raw['T1_Process']
    R32_PI5_Df['T2_Process'] = R32_PI5_Df_raw['T2_Process']
    R32_PI5_Df['T_Amb_Process'] = R32_PI5_Df_raw['T_Amb_Process']
    R32_PI5_Df['Power'] = R32_PI5_Df_raw['Power']
    R32_PI5_Df['MF_Suc'] = R32_PI5_Df_raw['MF_Suc']
    R32_PI5_Df['Dens_Suc'] = R32_PI5_Df_raw['Dens_Suc']
    R32_PI5_Df['h1'] = R32_PI5_Df_raw['h1']
    R32_PI5_Df['s1'] = R32_PI5_Df_raw['s1']
    R32_PI5_Df['v1'] = R32_PI5_Df_raw['v1']
    R32_PI5_Df['cp1'] = R32_PI5_Df_raw['cp1']
    R32_PI5_Df['h2'] = R32_PI5_Df_raw['h2']
    R32_PI5_Df['h2is'] = R32_PI5_Df_raw['h2is']
    R32_PI5_Df['s2'] = R32_PI5_Df_raw['s2']
    R32_PI5_Df['cp2'] = R32_PI5_Df_raw['cp2']
    R32_PI5_Df['tc'] = R32_PI5_Df_raw['tc']
    #R32_PI5_Df['lambda'] = R32_PI5_Df_raw['lambda']
    # R32_Df['T_Evaps'] = R32_Df_raw['T_Evaps']
    # R32_Df['T_Conds'] = R32_Df_raw['T_Conds']
...
def clean_R290_PI25_DF():
    ...
    #R290_PI25_Df['lambda'] = R290_PI25_Df_raw['lambda']
    # R32_Df['T_Evaps'] = R32_Df_raw['T_Evaps']
    # R32_Df['T_Conds'] = R32_Df_raw['T_Conds']
...
def clean_R290_PI3_DF():
    ...
    #R290_PI3_Df['lambda'] = R290_PI3_Df_raw['lambda']
...
def clean_R290_PI35_DF():
    ...
    #R290_PI35_Df['lambda'] = R290_PI35_Df_raw['lambda']
    # R32_Df['T_Evaps'] = R32_Df_raw['T_Evaps']
    # R32_Df['T_Conds'] = R32_Df_raw['T_Conds']
...
def clean_R290_PI4_DF():
    ...
    #R290_PI4_Df['lambda'] = R290_PI4_Df_raw['lambda']
...
def clean_R290_PI45_DF():
    ...
    #R290_PI45_Df['lambda'] = R290_PI45_Df_raw['lambda']
...
def clean_R290_PI5_DF():
    ...
    #R290_PI5_Df['lambda'] = R290_PI5_Df_raw['lambda']
    # R32_Df['T_Evaps'] = R32_Df_raw['T_Evaps']
    # R32_Df['T_Conds'] = R32_Df_raw['T_Conds']
...
def clean_R290_PI55_DF():
    ...
    #R290_PI55_Df['lambda'] = R290_PI55_Df_raw['lambda']
    # R32_Df['T_Evaps'] = R32_Df_raw['T_Evaps']
    # R32_Df['T_Conds'] = R32_Df_raw['T_Conds']
...
def clean_R290_PI6_DF():
    ...
    #R290_PI6_Df['lambda'] = R290_PI6_Df_raw['lambda']
...
def clean_R290_PI65_DF():
    ...
    #R290_PI65_Df['lambda'] = R290_PI65_Df_raw['lambda']
...
def clean_R410A_PI3_DF():
    ...
    #R410A_PI3_Df['lambda'] = R410A_PI3_Df_raw['lambda']
...
def clean_R410A_PI35_DF():
    ...
    #R410A_PI35_Df['lambda'] = R410A_PI35_Df_raw['lambda']
...
def clean_R410A_PI4_DF():
    ...
    #R410A_PI4_Df['lambda'] = R410A_PI4_Df_raw['lambda']
    # R32_Df['T_Evaps'] = R32_Df_raw['T_Evaps']
    # R32_Df['T_Conds'] = R32_Df_raw['T_Conds']
...
def clean_R410A_PI42_DF():
    ...
    #R410A_PI42_Df['lambda'] = R410A_PI42_Df_raw['lambda']
    # R32_Df['T_Evaps'] = R32_Df_raw['T_Evaps']
    # R32_Df['T_Conds'] = R32_Df_raw['T_Conds']
...
def clean_R410A_PI45_DF():
    ...
    #R410A_PI45_Df['lambda'] = R410A_PI45_Df_raw['lambda']
    # R32_Df['T_Evaps'] = R32_Df_raw['T_Evaps']
    # R32_Df['T_Conds'] = R32_Df_raw['T_Conds']
...
def clean_R410A_PI5_DF():
    ...
    #R410A_PI5_Df['lambda'] = R410A_PI5_Df_raw['lambda']
    # R32_Df['T_Evaps'] = R32_Df_raw['T_Evaps']
    # R32_Df['T_Conds'] = R32_Df_raw['T_Conds']
...
def clean_R410A_PI55_DF():
    ...
    #R410A_PI55_Df['lambda'] = R410A_PI55_Df_raw['lambda']
    # R32_Df['T_Evaps'] = R32_Df_raw['T_Evaps']
    # R32_Df['T_Conds'] = R32_Df_raw['T_Conds']
...
def clean_R410A_PI6_DF():
    ...
    #R410A_PI6_Df['lambda'] = R410A_PI6_Df_raw['lambda']
...
def clean_R410A_PI65_DF():
    ...
    #R410A_PI65_Df['lambda'] = R410A_PI65_Df_raw['lambda']
...
def clean_R454C_PI35_DF():
    ...
    #R454C_PI35_Df['lambda'] = R454C_PI35_Df_raw['lambda']
    # R32_Df['T_Evaps'] = R32_Df_raw['T_Evaps']
    # R32_Df['T_Conds'] = R32_Df_raw['T_Conds']
...
def clean_R454C_PI45_DF():
    ...
    #R454C_PI45_Df['lambda'] = R454C_PI45_Df_raw['lambda']
...
def clean_R454C_PI5_DF():
    ...
    #R454C_PI5_Df['lambda'] = R454C_PI5_Df_raw['lambda']
...
def clean_R454C_PI55_DF():
    ...
    #R454C_PI55_Df['lambda'] = R454C_PI55_Df_raw['lambda']
...
def clean_R454C_PI6_DF():
    ...
    #R454C_PI6_Df['lambda'] = R454C_PI6_Df_raw['lambda']
...
def clean_R454C_PI65_DF():
    ...
    #454C_PI65_Df['lambda'] = R454C_PI65_Df_raw['lambda']

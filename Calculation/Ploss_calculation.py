...
def func_P_Rosk(mass_flow,h2_isentrop, h1, P_elec):
    ...
    eta_is_rosk = P_is_ros/P_elec
    return P_loss , P_is_ros , eta_is_rosk
...
def P_R410A(R410A_Df):
    ...
    P_R410A['P_loss'], P_R410A['P_is'], P_R410A['eta_is_rosk'] = func_P_Rosk(R410A_Df['MF_Suc'],R410A_Df['h2is'],R410A_Df['h1'],R410A_Df['Power'])
...
def P_R32(R32_Df):
    ...
    P_R32['P_loss'], P_R32['P_is'], P_R32['eta_is_rosk'] = func_P_Rosk(R32_Df['MF_Suc'], R32_Df['h2is'], R32_Df['h1'],
                                                     R32_Df['Power'])
    ...
    return  P_R32#P_R32_pi25,P_R32_pi3, P_R32_pi35, P_R32_pi4, P_R32_pi45, P_R32_pi5
...
def P_R290(R290_Df):
    ...
    P_R290['P_loss'], P_R290['P_is'], P_R290['eta_is_rosk'] = func_P_Rosk(R290_Df['MF_Suc'], R290_Df['h2is'], R290_Df['h1'],
                                                     R290_Df['Power'])
    ...
    return P_R290# P_R290_pi25,P_R290_pi3, P_R290_pi35, P_R290_pi4, P_R290_pi45, P_R290_pi5, P_R290_pi55, P_R290_pi6, P_R290_pi65
...
def P_R454C(R454C_Df):
    ...
    P_R454C['P_loss'], P_R454C['P_is'] , P_R454C['eta_is_rosk']= func_P_Rosk(R454C_Df['MF_Suc'], R454C_Df['h2is'], R454C_Df['h1'],
                                                     R454C_Df['Power'])
    ...
    return  P_R454C# P_R454C_pi45, P_R454C_pi5, P_R454C_pi55,P_R454C_pi6,P_R454C_pi65
...
def P_R32_Pi25(R32_PI25_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R32_PI25['P_loss'], P_R32_PI25['P_is'], P_R32_PI25['eta_is_rosk'] = func_P_Rosk(R32_PI25_Df['MF_Suc'], R32_PI25_Df['h2is'], R32_PI25_Df['h1'],
                                                     R32_PI25_Df['Power'])
...
def P_R32_Pi3(R32_PI3_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R32_PI3['P_loss'], P_R32_PI3['P_is'], P_R32_PI3['eta_is_rosk'] = func_P_Rosk(R32_PI3_Df['MF_Suc'], R32_PI3_Df['h2is'], R32_PI3_Df['h1'],
                                                     R32_PI3_Df['Power'])
...
def P_R32_Pi35(R32_PI35_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R32_PI35['P_loss'], P_R32_PI35['P_is'] , P_R32_PI35['eta_is_rosk']= func_P_Rosk(R32_PI35_Df['MF_Suc'], R32_PI35_Df['h2is'], R32_PI35_Df['h1'],
                                                     R32_PI35_Df['Power'])
...
def P_R32_Pi4(R32_PI4_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R32_PI4['P_loss'], P_R32_PI4['P_is'], P_R32_PI4['eta_is_rosk'] = func_P_Rosk(R32_PI4_Df['MF_Suc'], R32_PI4_Df['h2is'], R32_PI4_Df['h1'],
                                                     R32_PI4_Df['Power'])
...
def P_R32_Pi45(R32_PI45_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R32_PI45['P_loss'], P_R32_PI45['P_is'], P_R32_PI45['eta_is_rosk'] = func_P_Rosk(R32_PI45_Df['MF_Suc'], R32_PI45_Df['h2is'], R32_PI45_Df['h1'],
                                                     R32_PI45_Df['Power'])
...
def P_R290_Pi25(R290_PI25_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R290_PI25['P_loss'], P_R290_PI25['P_is'], P_R290_PI25['eta_is_rosk'] = func_P_Rosk(R290_PI25_Df['MF_Suc'], R290_PI25_Df['h2is'], R290_PI25_Df['h1'],
                                                     R290_PI25_Df['Power'])
...
def P_R290_Pi3(R290_PI3_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R290_PI3['P_loss'], P_R290_PI3['P_is'], P_R290_PI3['eta_is_rosk'] = func_P_Rosk(R290_PI3_Df['MF_Suc'], R290_PI3_Df['h2is'], R290_PI3_Df['h1'],
                                                     R290_PI3_Df['Power'])
...
def P_R290_Pi35(R290_PI35_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R290_PI35['P_loss'], P_R290_PI35['P_is'], P_R290_PI35['eta_is_rosk'] = func_P_Rosk(R290_PI35_Df['MF_Suc'], R290_PI35_Df['h2is'], R290_PI35_Df['h1'],
                                                     R290_PI35_Df['Power'])
...
def P_R290_Pi4(R290_PI4_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R290_PI4['P_loss'], P_R290_PI4['P_is'], P_R290_PI4['eta_is_rosk'] = func_P_Rosk(R290_PI4_Df['MF_Suc'], R290_PI4_Df['h2is'], R290_PI4_Df['h1'],
                                                     R290_PI4_Df['Power'])
...
def P_R290_Pi45(R290_PI45_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R290_PI45['P_loss'], P_R290_PI45['P_is'], P_R290_PI45['eta_is_rosk'] = func_P_Rosk(R290_PI45_Df['MF_Suc'], R290_PI45_Df['h2is'], R290_PI45_Df['h1'],
                                                     R290_PI45_Df['Power'])
...
def P_R290_Pi5(R290_PI5_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R290_PI5['P_loss'], P_R290_PI5['P_is'], P_R290_PI5['eta_is_rosk'] = func_P_Rosk(R290_PI5_Df['MF_Suc'], R290_PI5_Df['h2is'], R290_PI5_Df['h1'],
                                                     R290_PI5_Df['Power'])
...
def P_R290_Pi55(R290_PI55_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R290_PI55['P_loss'], P_R290_PI55['P_is'], P_R290_PI55['eta_is_rosk'] = func_P_Rosk(R290_PI55_Df['MF_Suc'], R290_PI55_Df['h2is'], R290_PI55_Df['h1'],
                                                     R290_PI55_Df['Power'])
...
def P_R290_Pi6(R290_PI6_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R290_PI6['P_loss'], P_R290_PI6['P_is'], P_R290_PI6['eta_is_rosk'] = func_P_Rosk(R290_PI6_Df['MF_Suc'], R290_PI6_Df['h2is'], R290_PI6_Df['h1'],
                                                     R290_PI6_Df['Power'])
...
def P_R290_Pi65(R290_PI65_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R290_PI65['P_loss'], P_R290_PI65['P_is'], P_R290_PI65['eta_is_rosk'] = func_P_Rosk(R290_PI65_Df['MF_Suc'], R290_PI65_Df['h2is'], R290_PI65_Df['h1'],
                                                           R290_PI65_Df['Power'])
...
def P_R410A_Pi3(R410A_PI3_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R410A_PI3['P_loss'], P_R410A_PI3['P_is'], P_R410A_PI3['eta_is_rosk'] = func_P_Rosk(R410A_PI3_Df['MF_Suc'], R410A_PI3_Df['h2is'], R410A_PI3_Df['h1'],
                                                             R410A_PI3_Df['Power'])
...
def P_R410A_Pi35(R410A_PI35_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R410A_PI35['P_loss'], P_R410A_PI35['P_is'], P_R410A_PI35['eta_is_rosk'] = func_P_Rosk(R410A_PI35_Df['MF_Suc'], R410A_PI35_Df['h2is'], R410A_PI35_Df['h1'],
                                                             R410A_PI35_Df['Power'])
...
def P_R410A_Pi4(R410A_PI4_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R410A_PI4['P_loss'], P_R410A_PI4['P_is'], P_R410A_PI4['eta_is_rosk'] = func_P_Rosk(R410A_PI4_Df['MF_Suc'], R410A_PI4_Df['h2is'], R410A_PI4_Df['h1'],
                                                               R410A_PI4_Df['Power'])
...
def P_R410A_Pi45(R410A_PI45_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R410A_PI45['P_loss'], P_R410A_PI45['P_is'],P_R410A_PI45['eta_is_rosk'] = func_P_Rosk(R410A_PI45_Df['MF_Suc'], R410A_PI45_Df['h2is'], R410A_PI45_Df['h1'],
                                                             R410A_PI45_Df['Power'])
...
def P_R410A_Pi5(R410A_PI5_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R410A_PI5['P_loss'], P_R410A_PI5['P_is'], P_R410A_PI5['eta_is_rosk'] = func_P_Rosk(R410A_PI5_Df['MF_Suc'], R410A_PI5_Df['h2is'], R410A_PI5_Df['h1'],
                                                               R410A_PI5_Df['Power'])
...
def P_R410A_Pi55(R410A_PI55_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R410A_PI55['P_loss'], P_R410A_PI55['P_is'], P_R410A_PI55['eta_is_rosk'] = func_P_Rosk(R410A_PI55_Df['MF_Suc'], R410A_PI55_Df['h2is'], R410A_PI55_Df['h1'],
                                                             R410A_PI55_Df['Power'])
...
def P_R410A_Pi6(R410A_PI6_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R410A_PI6['P_loss'], P_R410A_PI6['P_is'], P_R410A_PI6['eta_is_rosk'] = func_P_Rosk(R410A_PI6_Df['MF_Suc'], R410A_PI6_Df['h2is'], R410A_PI6_Df['h1'],
                                                               R410A_PI6_Df['Power'])
...
def P_R410A_Pi65(R410A_PI65_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R410A_PI65['P_loss'], P_R410A_PI65['P_is'], P_R410A_PI65['eta_is_rosk'] = func_P_Rosk(R410A_PI65_Df['MF_Suc'], R410A_PI65_Df['h2is'], R410A_PI65_Df['h1'],
                                                             R410A_PI65_Df['Power'])
...
def P_R454C_Pi35(R454C_PI35_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R454C_PI35['P_loss'], P_R454C_PI35['P_is'], P_R454C_PI35['eta_is_rosk'] = func_P_Rosk(R454C_PI35_Df['MF_Suc'], R454C_PI35_Df['h2is'], R454C_PI35_Df['h1'],
                                                               R454C_PI35_Df['Power'])
...
def P_R454C_Pi45(R454C_PI45_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R454C_PI45['P_loss'], P_R454C_PI45['P_is'], P_R454C_PI45['eta_is_rosk'] = func_P_Rosk(R454C_PI45_Df['MF_Suc'], R454C_PI45_Df['h2is'], R454C_PI45_Df['h1'],
                                                               R454C_PI45_Df['Power'])
...
def P_R454C_Pi5(R454C_PI5_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R454C_PI5['P_loss'], P_R454C_PI5['P_is'], P_R454C_PI5['eta_is_rosk'] = func_P_Rosk(R454C_PI5_Df['MF_Suc'], R454C_PI5_Df['h2is'], R454C_PI5_Df['h1'],
                                                               R454C_PI5_Df['Power'])
...
def P_R454C_Pi55(R454C_PI55_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R454C_PI55['P_loss'], P_R454C_PI55['P_is'], P_R454C_PI55['eta_is_rosk'] = func_P_Rosk(R454C_PI55_Df['MF_Suc'], R454C_PI55_Df['h2is'], R454C_PI55_Df['h1'],
                                                             R454C_PI55_Df['Power'])
...
def P_R454C_Pi6(R454C_PI6_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R454C_PI6['P_loss'], P_R454C_PI6['P_is'] , P_R454C_PI6['eta_is_rosk']= func_P_Rosk(R454C_PI6_Df['MF_Suc'], R454C_PI6_Df['h2is'], R454C_PI6_Df['h1'],
                                                               R454C_PI6_Df['Power'])
...
def P_R454C_Pi65(R454C_PI65_Df):
    ...
    #P_R454C['P_loss'], P_R454C['P_is'] = func_P_theo(R454C_Df['Power'], eta_is_R454C)
    P_R454C_PI65['P_loss'], P_R454C_PI65['P_is'], P_R454C_PI65['eta_is_rosk'] = func_P_Rosk(R454C_PI65_Df['MF_Suc'], R454C_PI65_Df['h2is'], R454C_PI65_Df['h1'],
                                                             R454C_PI65_Df['Power'])
